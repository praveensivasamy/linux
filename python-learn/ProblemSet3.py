...
def problem3_1(txtfilename):
    txt_file=open(txtfilename)
    letter_count=0
    for line in txt_file:
        print(line,end="")
        letter_count=letter_count+len(line)
    print()
    print()
    print("There are",int(letter_count),"letters in the file.")
    txt_file.close()
#%%
"""
Problem 3_2:
...
def problem3_3(month, day, year):
    ...
    date_text=months[month]+" "+str(day)+", "+str(year)
    print(date_text)
#%%
"""
Problem 3_4:
...
def problem3_4(mon, day, year):
    ...
    date_num = str(dict_month[str(mon)])+"/"+ str(day) +"/"+ str(year)
    print(date_num)
